...
class AmazonECS {
	...
	protected function buildRequestParams($function, array $params) {
		...
		return array_merge(
			$associateTag, array(
				...
				'Request' => array_merge(
					array('Operation' => $function), $params, $this->responseConfig['optionalParameters'],
	 ...
	 * @return array|object The response as an array with stdClass objects
	 */
	...
	public function category($category = NULL) {
		if (NULL === $category) {
			return isset($this->requestConfig['category']) ?
				$this->requestConfig['category'] :
				NULL;
		}
